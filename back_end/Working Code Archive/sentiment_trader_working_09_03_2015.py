...
def execute_trading_strategy(ticker_symbol, day, cash_value, equities_position, position_value, position_quantity, close_position_value):
	...
	#returns JSON structure with all of the "tweets" that contain that ticker symbol
	formatted_relevant_data = capture_relevant_data(day, data_source, ticker_symbol, start_time, stop_time)
	#print "formatted data is: ", formatted_relevant_data
	
	
	#needs to loop through each "tweet" in data and determine a sentiment value for that tweet. Then needs to calculate and return a bear/bull ratio 
	#for the day
	market_sentiment, sentiment_volume = determine_market_sentiment(day, formatted_relevant_data)
...
#go through all of the data from the source above and restructure in common format ordered by date
#structured_data = get_data(data_sources, start_date, stop_date)
...
for day in day_index:
	...
	if data: #if data is returned then it is a trading day
		...
		portfolio_value, cash_value, equities_position, position_value, position_quantity, close_position_value, trade_action, market_sentiment, sentiment_volume = execute_trading_strategy(ticker_symbol, day, cash_value, equities_position, position_value, position_quantity, close_position_value)
